...
活塞在收回的状态是一个方块，但在伸出后占据了两个方块，它们是活塞的两个部分，我们把活塞没有移动的部分叫做活塞底座，或者我习惯叫作活塞底座，而伸出的那部分方块被称作活塞头，也可以叫作活塞臂。没错，活塞就是一个屁股决定脑袋的红石元件。
...
活塞头并不是一个会独立存在的方块，它所完成的所有事情都是由活塞底座完成的，当它受到更新时，将其传递给后方的活塞底座。
...
如果此时的活塞头是正在移动中的方块，也就是b36，会使这个活塞头位置的方块**强制到位**，来为之后的操作腾出空间。活塞本身也就是活塞底座会被设置成b36并给出方块更新及形状更新。
